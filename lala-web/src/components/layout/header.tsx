        ...
        <>
            ...
            >
                ...
                ">
                        ...
                        <nav className="xs:hidden tablet:w-[110px] sm:w-[130px] md:w-[150px] desk:w-[170px] flex items-center justify-between">
                            {navItems.map((item) => (
                                <Link
                                    ...
                                    className={`
                                        xs:text-xs tablet:text-base md:text-md lg:text-lg xl:text-xl desk:text-base
                    ...
                    {/* RIGHT SIDE */}
                    <div className="
                        xs:w-[140px] tablet:w-[160px] md:w-[180px] lg:w-[200px] xl:w-[230px] desk:w-[250px]
            ...
            {showLogoutModal && (
                <div className="fixed inset-0 bg-gray-400/30 backdrop-blur-sm flex items-center justify-center z-[200]">
